					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateReview()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div id="app">
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Reviews = true">Add</base-button>
								              <modal :show.sync="modal2Reviews">
								  ...
								  <base-input label="CreationDate" type="text" placeholder="Enter CreationDate" v-model="reviewToAdd.creationDate"></base-input>
												                  </form>
								                </div>
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Review Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ReviewId" type="text" placeholder="Enter ReviewId" v-model="reviewDetails.reviewId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Rating</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Rating" type="text" placeholder="Enter Rating" v-model="reviewDetails.rating"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Comment</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Creation Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="reviewDetails.creationDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateReview() {
      ...
      const jsonData = JSON.stringify(this.reviewDetails);
      const res = await ReviewService.update(jsonData);
...
//        this.getAllReviews();
    ...
    async getReviewDetails() {
      try {
			let response = await ReviewService.get(this.reviewId);
