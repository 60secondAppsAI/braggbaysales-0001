              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Registration Date</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Contact Information</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactInformation" type="text" placeholder="Enter ContactInformation" v-model="userDetails.contactInformation"></input>
																		</div>
						</td>
														</tr>
