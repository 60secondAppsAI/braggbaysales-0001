						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="ZipCode" type="text" placeholder="Enter ZipCode" v-model="addressToAdd.zipCode"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">State</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="State" type="text" placeholder="Enter State" v-model="addressDetails.state"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Zip Code</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ZipCode" type="text" placeholder="Enter ZipCode" v-model="addressDetails.zipCode"></input>
																		</div>
						</td>
														</tr>
