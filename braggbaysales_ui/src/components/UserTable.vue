...
<template>
  ...
  <base-input label="ContactInformation" type="text" placeholder="Enter ContactInformation" v-model="userToAdd.contactInformation"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'contactInformation',
          ...
          sorter: true
          //sorter: (a, b) => a.contactInformation - b.contactInformation,
          //sorter: (a, b) => a.contactInformation.localeCompare(b.contactInformation),
        },
      ],
      pagination: {
        current: 1,
