...
<template>
  ...
  <base-input label="PaymentAmount" type="text" placeholder="Enter PaymentAmount" v-model="paymentToAdd.paymentAmount"></base-input>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'paymentAmount',
          ...
          //sorter: (a, b) => a.paymentAmount.localeCompare(b.paymentAmount),
        },
        {
          title: 'Payment Date',
